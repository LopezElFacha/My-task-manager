...
login.addEventListener("submit", async e =>{
    ...
    if(isLogin){
        ...
        if(email.trim() == "" || contra.trim() == "" || nombre.trim() == "" || img == null || img == undefined || img.size > 5 * 1024 * 1024 || (img.type != 'image/gif' && img.type != 'image/png' && img.type != 'image/jpg' && img.type != 'image/jpeg')){
            error.classList.remove("d-none")
